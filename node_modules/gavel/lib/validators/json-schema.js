...
JsonSchema = (function() {
  ...
  JsonSchema.prototype.validateSchemaV4 = function() {
    var amandaCompatibleError, err, error, index, j, len, pathArray, pointer, result, validationErrors;
    ...
    for (index = j = 0, len = validationErrors.length; j < len; index = ++j) {
      err = validationErrors[index];
