...
class PlatformInformation {
    ...
    static GetWindowsArchitecture() {
        return __awaiter(this, void 0, void 0, function* () {
            const process = yield utility_1.Utility.exec("wmic os get osarchitecture");
            if (process.exitCode == 0) {
                let archArray = process.stdout.split(os.EOL);
    ...
    static GetUnixArchitecture() {
        return __awaiter(this, void 0, void 0, function* () {
            const process = yield utility_1.Utility.exec("uname -m");
