...
var Parser = (function () {
  ...
  _createClass(Parser, [{
    ...
    value: function parse(done) {
      ...
      var Category = _minim$elements.Category;
      var ParseResult = _minim$elements.ParseResult;
      var SourceMap = _minim$elements.SourceMap;
      ...
      swaggerParser.validate(loaded, swaggerOptions, function (err) {
        ...
        if (err) {
          ...
          if (err.details) {
            ...
            while (queue.length) {
              ...
              try {
                for (var _iterator = _getIterator(queue[0]), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (matches) {
            _location = [_this.source.indexOf(matches[1]), matches[1].length];
          }

          var annotation = _this.createAnnotation(_annotations2['default'].VALIDATION_ERROR, null, err.message);

          if (_location !== null) {
            annotation.attributes.set('sourceMap', [new SourceMap([_location])]);
          }
        ...
        try {
          var _ret = (function () {
            ...
            var pendingPaths = _Object$keys(paths).length;
            ...
            _lodash2['default'].forEach(paths, function (pathValue, href) {
              nextTick(function () {
    ...
    value: function oauthScopes(element, items) {
      ...
      var MemberElement = _minim$elements2.Member;
      var ArrayElement = _minim$elements2.Array;
      var StringElement = _minim$elements2.String;
      ...
      if (_lodash2['default'].isObject(items) && !_lodash2['default'].isArray(items)) {
        descriptions = _Object$values(items);
        scopesList = _Object$keys(items);
      }
    ...
    value: function handleSwaggerAuth() {
      ...
      var Category = _minim$elements3.Category;
      var AuthScheme = _minim$elements3.AuthScheme;
    ...
    value: function handleSwaggerPath(pathValue, href) {
      ...
      var Copy = _minim$elements4.Copy;
      var Resource = _minim$elements4.Resource;
    ...
    value: function handleSwaggerVendorExtensions(element, object) {
      ...
      if (_Object$keys(extensions).length > 0) {
        var _minim$elements5 = this.minim.elements;
        var Link = _minim$elements5.Link;
        var Extension = _minim$elements5.Extension;
    ...
    value: function handleSwaggerMethod(resource, href, resourceParameters, methodValue, method) {
      var _this8 = this;

      var _minim$elements6 = this.minim.elements;
      var Copy = _minim$elements6.Copy;
      var Transition = _minim$elements6.Transition;
      ...
      this.withPath(method, function () {
        ...
        var transitionParameters = methodValue.parameters || [];

        var queryParameters = transitionParameters.filter(function (parameter) {
        ...
        var hrefForTransition = (0, _uriTemplate2['default'])(_this8.basePath, href, resourceParameters, queryParameters);
        ...
        var methodHrefVariables = _this8.createHrefVariables(transitionParameters);
        ...
        if (_lodash2['default'].keys(relevantResponses).length === 0) {
          if (transitionParameters.filter(function (p) {
            return p['in'] === 'body';
          }).length) {
        ...
        _lodash2['default'].forEach(relevantResponses, function (responseValue, statusCode) {
          _this8.handleSwaggerResponse(transition, method, methodValue, transitionParameters, responseValue, statusCode, schemes, resourceParameters);
        });
    ...
    value: function handleSwaggerResponse(transition, method, methodValue, transitionParameters, responseValue, statusCode, schemes, resourceParameters) {
      var _this9 = this;
      ...
      _lodash2['default'].forEach(examples, function (responseBody, contentType) {
        ...
        _this9.handleSwaggerExampleRequest(transaction, methodValue, transitionParameters, resourceParameters);
    ...
    value: function handleSwaggerExampleRequest(transaction, methodValue, transitionParameters, resourceParameters) {
      var _this10 = this;
      ...
      this.withPath(function () {
        ...
        if (jsonConsumesContentType) {
          _headers2['default'].pushHeader('Content-Type', jsonConsumesContentType, request, _this10, 'consumes-content-type');
        }

        if (jsonProducesContentType) {
          _headers2['default'].pushHeader('Accept', jsonProducesContentType, request, _this10, 'produces-accept');
        }
        ...
        _lodash2['default'].forEach([[resourceParameters, '..'], [transitionParameters, '.']], function (parameters) {
            ...
            switch (param['in']) {
              case 'header':
                _lodash2['default'].set(parametersGenerator, [param['in'], param.name], _lodash2['default'].bind(_this10.withPath, _this10, parameters[1], 'parameters', index, function () {
                  _headers2['default'].pushHeaderObject(param.name, param, request, _this10);
                }));
                break;
              ...
              case 'body':
                _lodash2['default'].set(parametersGenerator, [param['in'], param.name], _lodash2['default'].bind(_this10.withPath, _this10, parameters[1], 'parameters', index, function () {
                  ...
                  _this10.withPath('schema', function () {
                    if (jsonConsumesContentType) {
                      _generator2['default'].bodyFromSchema(param.schema, request, _this10, jsonConsumesContentType);
                    }
              ...
              case 'formData':
                _lodash2['default'].set(parametersGenerator, [param['in'], param.name], _lodash2['default'].bind(_this10.withPath, _this10, parameters[1], 'parameters', index, function () {
                  ...
                  _this10.generateBodyFromFormParameter(param, formParamsSchema);
    ...
    value: function generateFormParameters(parameters, schema, request) {
      ...
      var DataStructure = _minim$elements7.DataStructure;
      var ObjectElement = _minim$elements7.Object;

      _headers2['default'].pushHeader('Content-Type', FORM_CONTENT_TYPE, request, this, 'form-data-content-type');

      _generator2['default'].bodyFromSchema(schema, request, this, FORM_CONTENT_TYPE);

      // Generating data structure
      var dataStructure = new DataStructure();
      var dataObject = new ObjectElement(); // a form is essentially an object with key/value members
    ...
    key: 'generateBodyFromFormParameter',
    value: function generateBodyFromFormParameter(param, schema) {
    ...
    value: function handleSwaggerExampleResponse(transaction, methodValue, responseValue, statusCode, responseBody, contentType) {
      ...
      var Asset = _minim$elements8.Asset;
      var Copy = _minim$elements8.Copy;
      ...
      this.withPath('responses', statusCode, function () {
        ...
        if (contentType) {
          _this11.withPath('examples', contentType, function () {
            _headers2['default'].pushHeader('Content-Type', contentType, response, _this11);
          });
        }
        ...
        if (jsonProducesContentType) {
          _headers2['default'].pushHeader('Content-Type', jsonProducesContentType, response, _this11, 'produces-content-type');
        }
        ...
        _this11.withPath('examples', function () {
          ...
          var schema = responseValue.schema || responseValue.examples && responseValue.examples.schema;
          ...
          if (schema) {
            ...
            _this11.withSlicedPath.apply(_this11, args.concat([function () {
              if (jsonProducesContentType !== undefined && responseBody === undefined) {
                _generator2['default'].bodyFromSchema(schema, response, _this11, jsonProducesContentType);
              }
    ...
    value: function updateHeaders(payload, httpHeaders) {
      ...
      var _loop = function (headerName) {
        if (httpHeaders.hasOwnProperty(headerName)) {
          /* eslint-disable no-loop-func */
          _this12.withPath('headers', headerName, function () {
            _headers2['default'].pushHeaderObject(headerName, httpHeaders[headerName], payload, _this12);
          });
    ...
    value: function updateResourceGroup(name) {
      ...
      var Category = _minim$elements9.Category;
      var Copy = _minim$elements9.Copy;
    ...
    value: function convertParameterToElement(parameter, path) {
      ...
      var setAttributes = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
      var _minim$elements10 = this.minim.elements;
      var ArrayElement = _minim$elements10.Array;
      var BooleanElement = _minim$elements10.Boolean;
      var NumberElement = _minim$elements10.Number;
      var StringElement = _minim$elements10.String;
    ...
    value: function createAnnotation(info, path, message) {
      ...
      if (info.fragment) {
        _link2['default'].origin(info.fragment, annotation, this);
      }
    ...
    value: function pushSchemaAsset(schema, payload, path) {
      ...
      try {
        ...
        var schemaAsset = new Asset(JSON.stringify(actualSchema));
    ...
    value: function createTransaction(transition, method, schemes) {
      ...
      var HttpRequest = _minim$elements11.HttpRequest;
      var HttpResponse = _minim$elements11.HttpResponse;
      var HttpTransaction = _minim$elements11.HttpTransaction;
    ...
    get: function get() {
      ...
      if (_lodash2['default'].isString(this.source)) {
        try {
          this._ast = new _ast2['default'](this.source);
        } catch (err) {
          this._ast = null;
